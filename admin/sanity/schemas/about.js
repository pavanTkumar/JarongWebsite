...
export default {
    ...
    fields: [
      ...
      },
      {
        ...
        title: 'CTA Text',
        type: 'text',
        initialValue: 'Whether you're planning a relaxing getaway to Gambia, seeking adventure across Africa, or need assistance with flights and accommodations, we're here to make your travel dreams a reality.'
      }
    ],
    preview: {
      select: {
