            ...
            {isSubmitted ? (
              <div className="bg-green-50/20 backdrop-blur-md p-6 rounded-xl text-center">
                ...
                <p className="text-white/90 mb-4">
                  ...
                  be redirected to complete your booking.
                </p>
                <Link
                  href="/booking"
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  ...
                  <div>
                    ...
                    >
                      ...
                      <option value="1" className="bg-blue-900">
                        1 traveler
                      </option>
                      <option value="2" className="bg-blue-900">
                        2 travelers
                      </option>
                      <option value="3-5" className="bg-blue-900">
                        3-5 travelers
                      </option>
                      <option value="6+" className="bg-blue-900">
                        6+ travelers
                      </option>
                    </select>
                  </div>
