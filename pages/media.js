  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Explore our travel blog for tips, guides, and inspiration for your next adventure. Discover destination guides, travel photography, and cultural insights." />
      </Head>
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="max-w-3xl">
            ...
            <p className="text-xl text-white/90 mb-8">
              Inspiration, tips, and stories to fuel your wanderlust and enhance your travel experiences
            </p>
          </div>
        </div>
      </section>
            ...
            <div className="flex flex-col lg:flex-row gap-8 bg-gray-50 rounded-xl overflow-hidden">
              <div className="w-full lg:w-1/2 h-80 lg:h-auto overflow-hidden">
                <div 
                  ...
                  style={{ backgroundImage: `url(${filteredPosts[0].mainImage ? urlFor(filteredPosts[0].mainImage) : '/images/placeholder.jpg'})` }}
                ></div>
              </div>
              <div className="w-full lg:w-1/2 p-8 flex flex-col justify-center">
                <div className="flex items-center space-x-2 mb-4">
                  <span className="text-blue-600 font-medium">{filteredPosts[0].category.charAt(0).toUpperCase() + filteredPosts[0].category.slice(1)}</span>
                  <span className="text-gray-400">•</span>
                  <span className="text-gray-500">{new Date(filteredPosts[0].publishedAt).toLocaleDateString('en-US', { year: 'numeric', month: 'long', day: 'numeric' })}</span>
                </div>
      ...
      {/* Blog Posts Grid */}
      <section className={`py-16 ${filteredPosts.length > 0 && activeCategory === 'all' ? 'bg-gray-50' : 'bg-white'}`}>
        <div className="container mx-auto px-6">
                ...
                <Link href={`/media/${post.slug.current}`}>
                  <div className="h-56 overflow-hidden">
                    <div 
                      ...
                      style={{ backgroundImage: `url(${post.mainImage ? urlFor(post.mainImage) : '/images/placeholder.jpg'})` }}
                    ></div>
                  </div>
                </Link>
                <div className="p-6">
                  <div className="flex items-center space-x-2 mb-3">
                    <span className="text-blue-600 font-medium">{post.category.charAt(0).toUpperCase() + post.category.slice(1)}</span>
                    <span className="text-gray-400">•</span>
                    <span className="text-gray-500">{new Date(post.publishedAt).toLocaleDateString('en-US', { year: 'numeric', month: 'long', day: 'numeric' })}</span>
                  </div>
                  <Link href={`/media/${post.slug.current}`}>
          ...
          <div className="max-w-3xl mx-auto text-center">
            ...
            >
              <input 
                ...
                required
              />
              <button type="submit" className="px-6 py-3 bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-lg transition-colors">
                Subscribe
              </button>
            </motion.form>
          </div>
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto bg-gray-50 rounded-xl p-8 md:p-12">
            <div className="text-center mb-8">
              <h2 className="text-3xl font-bold text-gray-900 mb-4">Advertise With Us</h2>
              <p className="text-gray-600 max-w-2xl mx-auto">
                Reach a targeted audience of travel enthusiasts and adventure seekers. 
                Partner with us to showcase your business, products, or services.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
              <div className="bg-white p-6 rounded-lg shadow">
                ...
                <p className="text-gray-600">Feature your products or services in our blog posts and travel guides</p>
              </div>
              
              <div className="bg-white p-6 rounded-lg shadow">
                <div className="text-blue-600 text-2xl font-bold mb-2">02</div>
                <h3 className="text-lg font-bold text-gray-900 mb-2">Banner Advertising</h3>
                <p className="text-gray-600">Place your ads in strategic locations throughout our website</p>
              </div>
              ...
              <div className="bg-white p-6 rounded-lg shadow">
                ...
                <p className="text-gray-600">Reach our subscribers through our newsletter campaigns</p>
              </div>
            </div>
