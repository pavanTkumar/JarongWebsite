  ...
  const missionValues = aboutData?.missionValues || [
    {
      ...
      description:
        "We connect travelers with genuine local experiences that go beyond typical tourist attractions, creating meaningful cultural exchanges and deeper understanding.",
    },
    {
      icon: "lock",
      title: "Trust & Reliability",
      description:
        "We build lasting relationships with our clients through transparent communication, attention to detail, and a commitment to exceeding expectations with every interaction.",
    },
    {
      icon: "earth",
      title: "Sustainable Tourism",
      description:
        "We promote responsible travel practices that minimize environmental impact and ensure tourism benefits local communities and preserves cultural heritage.",
    },
  ];
    ...
    <>
      <Head>
        ...
        <meta
          ...
          content={
            aboutData?.subtitle ||
            "Learn about JarongMedia, our story, mission, and the team behind our travel services. Discover why we're passionate about creating unforgettable travel experiences."
          }
        />
      </Head>
      ...
      <section className="relative pt-24 pb-16 bg-blue-900">
        <div className="absolute inset-0 opacity-30">
          <div
            ...
            style={{
              backgroundImage: aboutData?.mainImage
              ...
              {companyStory ? (
                ...
                <>
                  <p className="text-gray-600 mb-4">
                    JarongMedia was born from a deep passion for travel and a
                    desire to share the beauty of unique destinations,
                    particularly the untapped wonders of Gambia and other
                    African regions.
                  </p>
                  <p className="text-gray-600 mb-4">
                    What began as a personal journey to explore
                    off-the-beaten-path locations evolved into a mission to
                    create tailored travel experiences that connect travelers
                    with authentic cultures, stunning landscapes, and
                    unforgettable memories.
                  </p>
                  <p className="text-gray-600 mb-4">
                    Over the years, we've grown from a small operation to a
                    trusted travel partner for clients from around the world,
                    always maintaining our commitment to personalized service
                    and unique experiences.
                  </p>
                  <p className="text-gray-600">
                    Today, we pride ourselves on our deep knowledge of our
                    destinations, our attention to detail, and our ability to
                    craft travel experiences that go beyond the ordinary.
                  </p>
                </>
              )}
            </motion.div>
          ...
          <div className="max-w-3xl mx-auto text-center">
            ...
            >
              {aboutData?.missionStatement ||
                "To provide exceptional travel experiences that create lasting memories, foster cultural understanding, and promote sustainable tourism practices that benefit local communities."}
            </motion.p>
          </div>
      ...
      <section className="py-16 bg-blue-900 text-white">
        <div className="container mx-auto px-6">
          <div className="max-w-3xl mx-auto text-center">
            ...
            >
              {aboutData?.ctaText ||
                "Whether you are planning a relaxing getaway to Gambia, seeking adventure across Africa, or need assistance with flights and accommodations, we are here to make your travel dreams a reality."}
            </motion.p>
            <motion.div
