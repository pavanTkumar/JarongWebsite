  ...
  const processProductImage = (product) => {
    ...
    if (product.image && product.image.asset) {
      try {
        ...
        console.error(
          "Error generating image URL for product:",
          product.title,
          error
        );
  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Discover our trusted travel partners and exclusive deals on essential travel services and products."
        />
      </Head>
        ...
        <div className="container mx-auto px-6 relative">
          <div className="max-w-3xl">
            ...
            <p className="text-xl text-white/90 mb-8">
              We've partnered with trusted travel brands to bring you exclusive
              deals on essential travel services and products
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="max-w-4xl mx-auto bg-blue-50 rounded-xl p-8 md:p-12">
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600 max-w-2xl mx-auto">
                Join our affiliate program to promote your travel-related
                products or services to our audience. Get access to our growing
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
              <div className="bg-white p-6 rounded-lg shadow">
                ...
                <p className="text-gray-600">
                  Complete our simple application form to join the affiliate
                  program
                </p>
              </div>
              ...
              <div className="bg-white p-6 rounded-lg shadow">
                ...
                <p className="text-gray-600">
                  Our team will review your application and provide quick
                  approval
                </p>
              </div>
              ...
              <div className="bg-white p-6 rounded-lg shadow">
                ...
                <p className="text-gray-600">
                  Begin promoting your products and earning commissions
                </p>
              </div>
            </div>
...
export async function getStaticProps() {
  ...
  try {
    ...
    console.log(
      `Fetched ${affiliateProducts?.length || 0} affiliate products in ${queryDuration}ms`
    );
        ...
        : [
            {
              ...
              description:
                "Comprehensive travel insurance for your peace of mind. Coverage includes trip cancellation, medical emergencies, lost baggage, and more.",
            ...
            },
            {
              ...
              description:
                "Durable, water-resistant backpack perfect for all your travel adventures. Multiple compartments and comfortable straps.",
              image: "/images/placeholder.jpg",
              category: "gear",
              url: "#",
              rating: 4.8,
            },
            {
              ...
              description:
                "Special rates at partner hotels across Africa. Book through us and save up to 20% off regular rates.",
              image: "/images/placeholder.jpg",
