...
export default function TravelPackages({ packages }) {
  ...
  const handleFilterChange = (e) => {
    ...
    if (
      (filters.destination && name !== "destination") ||
      (value && name === "destination")
    ) {
      const destinationValue =
        name === "destination" ? value : filters.destination;
      if (destinationValue !== "") {
    ...
    if (
      (filters.duration && name !== "duration") ||
      (value && name === "duration")
    ) {
  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Explore our curated travel packages to destinations across Africa and beyond. Find your perfect vacation with JarongMedia."
        />
      </Head>
        ...
        <div className="container mx-auto px-6 relative ">
          <div className="max-w-3xl">
            ...
            <p className="text-xl text-white/90 mb-8">
              Curated experiences to the most breathtaking destinations around
              the world
            </p>
          </div>
        </div>
        ...
        <div className="container mx-auto px-6">
          <div className="flex flex-wrap items-center justify-between">
            <div className="w-full md:w-auto mb-4 md:mb-0">
              <h2 className="text-xl font-semibold sm:mb-1 md:mb-0 text-gray-800">
              ...
              >
                <div className="relative h-64 overflow-hidden">
                  <div
                    ...
                    style={{
                      backgroundImage: `url(${pkg.mainImage ? getSanityImageUrl(pkg.mainImage) : "/images/placeholder.jpg"})`,
                    }}
                  ></div>
          ...
          {filteredPackages.length === 0 && (
            <div className="text-center py-12">
              ...
              <p className="text-gray-600">
                ...
                or try different filter options.
              </p>
            </div>
          )}
        </div>
          ...
          <div className="bg-white rounded-2xl shadow-lg p-8 md:p-12">
            <div className="flex flex-col md:flex-row items-center justify-between">
              <div className="mb-6 md:mb-0 md:mr-8">
                ...
                <p className="text-gray-600">
                  Contact us for a custom travel package tailored to your
                  preferences.
                </p>
              </div>
              <Link
